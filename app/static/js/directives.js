// angular.module('knowBase').directive("scroll", function ($window) {
...
//     /* DOM element with md-header-top attribute (top in header) */
//     var top        = angular.element(document.querySelector('[md-header-top]'));
...
//     /* The zoom scale of the toolbar title when it's placed at the bottom of the header top */
//     var titleZoom      = 1.8;
//     /* The primary color palette used by Angular Material */
//     var primaryColor   = [255,179,0];
...
//       top.css('background-position','50% '+(ratio(dim)*50)+'%');
//       /* Uncomment the line below if you want shadow inside top (low performance) */
